...
At [Crosmos](https://x.com/crosmoslabs) we decided to have a similar approach. You can checkout our [docs](https://docs.crosmos.dev/) to understand the approach we took after iterating over multiple architectures.
