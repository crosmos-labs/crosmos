...
- **Billing information.** For paid plans, payment is processed by a third-party payment provider. We do not store full payment card numbers on our systems.
...
For paid plans, we also use billing information to process payments and keep the financial records required by applicable law.
