	...
	return (
		<div className="flex flex-col gap-3 rounded-lg border bg-card/40 p-3">
			...
			{membersError ? (
				...
				<p className="text-sm text-muted-foreground">
					Pick a member to see which private memory owners are visible to them.
				</p>
			) : previewError ? (
				<p className="text-sm text-muted-foreground">
					...
					{!preview.visibility_enabled && (
						<Alert>
							...
							<AlertDescription>
								...
								org-shared content. The list below is the grant-derived private
								owner scope when rules are activated.
							</AlertDescription>
						</Alert>
					)}
