...
import { useIsMobile } from "@crosmos/ui/hooks/use-mobile";
...
const SIDEBAR_ICON_PANEL_CLOSED =
...
function SidebarToggleIcon({
	...
	const panelPath = isOpen
		? SIDEBAR_ICON_PANEL_OPEN
		: SIDEBAR_ICON_PANEL_CLOSED;
	...
	return (
		<SidebarContext.Provider value={contextValue}>
			<div
				...
				className={cn(
					"group/sidebar-wrapper flex flex-1 min-h-0 w-full has-data-[variant=inset]:bg-sidebar",
					className,
				)}
				{...props}
			>
...
function SidebarTrigger({
	...
	return (
		<Button
			...
			{...props}
		>
			<SidebarToggleIcon isOpen={isMobile ? openMobile : open} />
...
function SidebarGroupLabel({
	...
	return (
		<Comp
			...
			className={cn(
				"flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium text-sidebar-foreground/40 ring-sidebar-ring outline-hidden transition-[margin,opacity] duration-200 ease-in-out group-data-[collapsible=icon]:-mt-8 group-data-[collapsible=icon]:opacity-0 focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
				className,
			)}
			{...props}
		/>
...
const sidebarMenuButtonVariants = cva(
	"peer/menu-button group/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm ring-sidebar-ring outline-hidden transition-[width,height,padding,background-color,color] duration-200 ease-in-out group-has-data-[sidebar=menu-action]/menu-item:pr-8 group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-open:hover:bg-sidebar-accent data-open:hover:text-sidebar-accent-foreground data-active:bg-sidebar-accent data-active:font-medium data-active:text-sidebar-accent-foreground [&_svg]:size-4 [&_svg]:shrink-0 [&>span:last-child]:truncate",
	{
		variants: {
			variant: {
