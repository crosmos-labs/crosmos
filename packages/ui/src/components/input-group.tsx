...
import { Textarea } from "@crosmos/ui/components/textarea";
...
function InputGroupInput({
	...
	return (
		<Input
			...
			className={cn(
				"flex-1 rounded-none border-0 bg-transparent shadow-none ring-0 focus-visible:ring-0 disabled:bg-transparent aria-invalid:ring-0 dark:bg-transparent dark:disabled:bg-transparent hover:bg-transparent",
				className,
			)}
			{...props}
		/>
